...
- **Learning**: AI/ML applications in education, business/data analytics, and accessibility in technology 
- **Pursuing**: AI Fundamentals and Applications Certificate from UF's Herbert Wertheim College of Engineering
...
![Fusion360](https://img.shields.io/badge/-Fusion360-FF6B00?style=flat&logo=autodesk&logoColor=white)
...
### Graph Alt-Text Converter
An accessible web application that automatically generates alternative text descriptions for graphs and charts using OpenAI's API. Built with Terminal4 to enhance accessibility for University of Florida users and support STEM education.
...
- **Tech:** Python, IoT, APIs, 3D Modeling, Arduino

## Education & Certifications

**Education:**
- B.S. in Information Systems | Minor in Innovation - *UF Warrington College of Business* (Aug 2026)
- AI Fundamentals and Applications Certificate - *UF Herbert Wertheim College of Engineering* (Aug 2026)

**Certifications:**
- C++ Programming Professional Certificate - OpenEDG
- Docker Foundations Professional Certificate
- Career Essentials in Project Management - Microsoft
- Technology to Captivate Students - UF
...
## 📊 GitHub Stats
![Kaiya's GitHub stats](https://github-readme-stats.vercel.app/api?username=kaiyacooper&show_icons=true&theme=radical)
